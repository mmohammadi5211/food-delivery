  ...
  const uploadImage = (e) => {
    ...
    uploadTask.on(
      ...
      (error) => {
        console.log(error);
        setFields(true);
        setMsg("Error while uploading : try Agin 🙇");
      ...
      >
        ...
        <div className="w-full ">
          <select
            ...
            border-b-2 border-gray-200 p-2 rounded-md
            cursor-pointer"
          >
        ...
        flex-col border-2 border-dotted border-gray-300 
        ...
        <div className="flex items-center w-full mt-8 md:mt-1">
          <button
            type="button"
            className="ml-0 md:ml-auto w-full md:w-auto
          border-none outline-none bg-emerald-500 px-12 py-2
